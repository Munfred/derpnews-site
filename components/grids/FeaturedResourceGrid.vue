...
import FeaturedPresentationalGrid from './FeaturedPresentationalGrid'

export default {
  name: 'FeaturedResourceGrid',
  components: { FeaturedPresentationalGrid },
  props: {
